...
public abstract class Bag {
     ...
     */
    public void setColor(String pickColor){
    ...
    public String popItem(){
        ...
        String itemDelete = this.contents[this.contents.length - 2];
